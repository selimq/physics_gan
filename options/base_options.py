...
#        self.parser.add_argument('--dataroot', required=True, default='./datasets/text_deblurring', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--name', type=str, default='text_deblur', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--scale', type=int, default=4, help='the scale in super-resolution')
